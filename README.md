...
| ```community.aws.acm_certificate_info``` | ```No``` |
...
| ```community.aws.autoscaling_launch_config``` | ```No``` |
| ```community.aws.autoscaling_launch_config_find``` | ```No``` |
...
| ```community.aws.ecs_cluster``` | ```No``` |
| ```community.aws.ecs_ecr``` | ```No``` |
| ```community.aws.ecs_service``` | ```No``` |
| ```community.aws.ecs_tag``` | ```No``` |
| ```community.aws.ecs_task``` | ```No``` |
| ```community.aws.ecs_taskdefinition``` | ```No``` |
| ```community.aws.efs``` | ```No``` |
...
| ```community.aws.sns``` | ```No``` |
| ```community.aws.sns_topic``` | ```No``` |
| ```community.aws.sqs_queue``` | ```No``` |
